...
class InternalMapsController(
	...
	fun calculatePreviewRoute(@RequestBody request: RoutePreviewRequest): RouteCalculationResponse {
		val result = routeCalculationPort.calculatePreviewRoute(
...
data class RoutePreviewRequest(val waypoints: List<RoutePreviewWaypoint>)
data class RoutePreviewWaypoint(val googlePlaceId: String, val latitude: Double, val longitude: Double)
